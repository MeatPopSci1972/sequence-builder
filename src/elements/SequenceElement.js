...
class SequenceElement {
   ...
   */
  getBounds() { throw new Error(this.constructor.name + '.getBounds() not implemented'); }
   ...
   * @returns {boolean}
   */
  hitTest(x, y) { throw new Error(this.constructor.name + '.hitTest() not implemented'); }
   ...
   */
  getPropertiesSchema() { throw new Error(this.constructor.name + '.getPropertiesSchema() not implemented'); }
   ...
   */
  render(layer, ctx) { throw new Error(this.constructor.name + '.render() not implemented'); }
   ...
   * @param {object} ctx — InteractionContext
   */
  renderSelected(interactionLayer, ctx) { /* default: no-op — override for selection chrome */ }
   ...
   * @param {object} ctx — InteractionContext
   */
  onDragStart(e, ctx) { /* default: no-op */ }
   ...
   * @param {object} ctx — InteractionContext
   */
  onDragMove(e, ctx) { /* default: no-op */ }
   ...
   * @param {object} ctx — InteractionContext
   */
  onDragEnd(e, ctx) { /* default: no-op */ }

  /**
   * Called when this element becomes selected.
   * @param {object} ctx — InteractionContext
   */
  onSelect(ctx) { /* default: no-op */ }

  /**
   * Called when this element is deselected.
   * @param {object} ctx — InteractionContext
   */
  onDeselect(ctx) { /* default: no-op */ }
}
