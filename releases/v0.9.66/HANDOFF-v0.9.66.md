...
## VERSION
- Current: 0.9.66
- Bump pattern: html.split('0.9.66').join('0.9.67')
- Release handoff: https://github.com/MeatPopSci1972/sequence-builder/blob/main/releases/v0.9.66/sequence-builder.html
