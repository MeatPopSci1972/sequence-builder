...
- `## VERSION — Current:` — must match `GET /status` → `version` field (0.9.69)
- `## VERSION — Bump pattern:` — must be `html.split('0.9.69').join('0.9.70')`
- `## VERSION — Release handoff URL:` — must point to current version snapshot (0.9.69)
