...
## VERSION
- Current: 0.9.104
- Bump pattern: html.split('0.9.104').join('0.9.105')
- Release handoff: https://github.com/MeatPopSci1972/sequence-builder/blob/main/releases/v0.9.104/sequence-builder.html
...
- `## VERSION — Current:` — must match `GET /status` → `version` field (0.9.104)
- `## VERSION — Bump pattern:` — must be `html.split('0.9.104').join('0.9.105')`
- `## VERSION — Release handoff URL:` — must point to current version snapshot (0.9.104)
