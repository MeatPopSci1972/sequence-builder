...
## VERSION
- Current: 0.9.94
- Bump pattern: html.split('0.9.94').join('0.9.95')
- Release handoff: https://github.com/MeatPopSci1972/sequence-builder/blob/main/releases/v0.9.94/sequence-builder.html
