...
## VERSION
- Current: 0.9.83
- Bump pattern: html.split('0.9.83').join('0.9.84')
- Release handoff: https://github.com/MeatPopSci1972/sequence-builder/blob/main/releases/v0.9.83/sequence-builder.html
...
- `## VERSION — Current:` — must match `GET /status` → `version` field (0.9.83)
- `## VERSION — Bump pattern:` — must be `html.split('0.9.83').join('0.9.84')`
- `## VERSION — Release handoff URL:` — must point to current version snapshot (0.9.83)
